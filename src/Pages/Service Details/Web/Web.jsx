...
const Web = () => {
    return (
        <div className="px-20 py-10">
            ...
            <h2 className="text-xl font-semibold text-gray-400 mt-5">Web Development</h2>
            <h2 className="text-5xl font-bold my-5 text-white">We don't just sell websites, we create websites that SELL.</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-white">
                <div className="bg-[#151724] h-[550px] p-10 text-center space-y-4 rounded-3xl">
                    ...
                    <div className="space-y-8">
                        <h2 className="text-center text-6xl font-bold">$48/<span className="text-xl">month</span></h2>
                ...
                <div className="bg-[#151724] h-[550px] p-10 text-center space-y-4 rounded-3xl">
                    ...
                    <div className="divider divider-warning"></div>
                    <div className="space-y-8">
                        <h2 className="text-center text-6xl font-bold">$78/<span className="text-xl">month</span></h2>
                        <button className="btn bg-[#E76A18] border-none">BUY NOW</button>
                    </div>
                </div>
                <div className="bg-[#151724] h-[550px] p-10 text-center space-y-4 rounded-3xl">
                    ...
                    <div className="divider divider-warning"></div>
                    <div className="space-y-8">
                        <h2 className="text-center text-6xl font-bold">$98/<span className="text-xl">month</span></h2>
                        <button className="btn bg-[#E76A18] border-none">BUY NOW</button>
                    </div>
                </div>
