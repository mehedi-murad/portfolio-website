...
const Graphic = () => {
    return (
        <div className="px-20 py-10">
            <div>
                <img className="rounded-lg" src="https://i.ibb.co/W64RZp1/i-Stock-1191609321-1.jpg" alt="" />
            </div>  
            <h2 className="text-xl font-semibold text-gray-400 mt-5">Graphic Design</h2>
